...
!(function (t, e) {
  ...
  function X(t, e) {
    ...
    if (
      ((e._time || (e._initted && !e._dur)) &&
        ((r = I(t.rawTime(), e)),
        (!e._dur || Ae(0, e.totalDuration(), r) - e._tTime > Wt) &&
          e.render(r, !0)),
    ...
    De = function (t, e, r) {
      return yt && !e && yt.selector
        ...
        ? re(t)
          ...
          ? [t]
          : []
        : Ce.call((e || bt).querySelectorAll(t), 0);
    },
      ...
      fe.SteppedEase =
        {
          config: function (t, e) {
            ...
            var r = 1 / t,
              ...
              n = e ? 1 : 0;
            return function (t) {
              return (((i * Ae(0, 0.99999999, t)) | 0) + n) * r;
            };
          },
        }),
    (Qt.ease = Ie["quad.out"]),
  ...
  var He = (function (t) {
    ...
    return (
      ...
      (o.tweenFromTo = function (t, e, r) {
        return this.tweenTo(e, C({ startAt: { time: ke(this, t) } }, r));
      }),
      (o.recent = function () {
        return this._recent;
      }),
  ...
  C(He.prototype, { _lock: 0, _hasPause: 0, _forcing: 0 });
  var Je,
    Ke,
  ...
  var sr = (function (t) {
    function n(e, i, n, a) {
      ...
      return (
        !0 !== A || gt || ((Je = r(h)), xt.killTweensOf(B), (Je = 0)),
        N(F, r(h), n),
  ...
  C(sr.prototype, { _targets: [], _lazy: 0, _startAt: 0, _op: 0, _onInit: 0 }),
    ...
    cn = function (t, e) {
      ...
      return (
        ...
        r.svg &&
          ...
          di(t, A || U, !!A || r.originIsAbsolute, !1 !== r.smooth, m)),
        (_ = r.xOrigin || 0),
        (d = r.yOrigin || 0),
        m !== fn &&
          ((T = m[0]),
          ...
          6 === m.length
            ...
            : ((F = m[6]),
              ...
              (u = (g = Hi(w, T)) * Gi),
              g &&
                ((A = T * (v = Math.cos(g)) + w * (y = Math.sin(g))),
                (C = O * v + k * y),
                (w = w * v - T * y),
                (k = k * v - O * y),
                (T = A),
        ...
        (r.renderTransform = r.svg ? yn : Ai ? vn : _n),
        (r.uncache = 0),
        r
      );
    },
